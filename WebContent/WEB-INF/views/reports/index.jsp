...
<c:import url="../layout/app.jsp">
    <c:param name="content">
        ...
        <h2>日報管理システムへようこそ</h2>
        <h3>【出退勤】</h3>
        <table id="report_start_finish">
            <tbody>
                <tr>
                    <th class="report_name">氏名</th>
                    <th class="report_date">日付</th>
                    <th class="report_confirm">出退勤</th>
                    <th class="report_action">確認</th>
                </tr>
                <c:forEach var="report" items="${reports}" varStatus="status">
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="report_confirm"><c:out value="$report.confirmed_at"/><c:out value="$report.finished_at"/></td>
                        <td class="report_action"><a
                            href="<c:url value='/reports/start_finish?id=${report.id}' />">変更する</a></td>
                    </tr>
                </c:forEach>
            </tbody>
